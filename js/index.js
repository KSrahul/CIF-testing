window.onload = function() {
    ...
    // Try to geeting, that if screen size is less than 716 that only this code will be work
    ...
    // Try to geeting, that if screen size is less than 716 that only this code will be work (End)
